...
import vn.wnav.jobhunter.domain.request.ReqLoginDTO;
import vn.wnav.jobhunter.domain.response.ResLoginDTO;
...
public class AuthController {
    ...
    @Value("${wnav.jwt.refresh-token-validity-in-seconds}")
    ...
    public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody ReqLoginDTO loginDto) {
        ...
        User currentUserDB = this.userService.handelGetUserByUsername(loginDto.getUsername());
    ...
    public ResponseEntity<ResLoginDTO> geRefreshToken(
