...
import vn.wnav.jobhunter.domain.response.file.ResUploadFileDTO;
import vn.wnav.jobhunter.service.FileService;
import vn.wnav.jobhunter.util.annotation.ApiMessage;
import vn.wnav.jobhunter.util.error.StorageException;

@RestController
@RequestMapping("/api/v1")
public class FileController {
    @Value("${wnav.upload-file.base-uri}")
